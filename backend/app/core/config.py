...
class Settings:
    ...
    SUPABASE_SERVICE_ROLE_KEY: str =os.getenv("SUPABASE_SERVICE_ROLE_KEY","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5mcW51eXdmbXFxc2F2YWxndGRvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTg2NjYwMSwiZXhwIjoyMDYxNDQyNjAxfQ.5O4q_MkSHOvY9BSty5U8zldSOQJlVt459IxQyPUvQ1g")
